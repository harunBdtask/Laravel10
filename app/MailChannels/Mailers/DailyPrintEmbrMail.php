...
class DailyPrintEmbrMail implements MailingChannelContract, MailingChannelAttachAbleContract
{
    public function attachment(): array
    {
        $filePath = MailDTO::getDailyPrintEmbrAttachmentName();
        return [
    ...
    {
        return 'auto_mail.daily_print_embr.mail_body';
    }

    public function subject(): string
    {
        return 'Daily Print Embr.';
    }

    public function receivers(): array
    {
        return MailDTO::getReceivers('daily_print_embr');
    }
}
