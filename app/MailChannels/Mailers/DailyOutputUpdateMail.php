...
class DailyOutputUpdateMail implements MailingChannelContract, MailingChannelAttachAbleContract
{

    public function attachment(): array
    {
        $filePath = MailDTO::getDailyOutputAttachmentName();
        return [
    ...
    {
        return 'auto_mail.daily_output_update.mail_body';
    }

    public function subject(): string
    {
        return 'Daily Output Update';
    }

    public function receivers(): array
    {
        return MailDTO::getReceivers('daily_output_report');
    }
}
