...
class DailyCuttingUpdateMail implements MailingChannelContract, MailingChannelAttachAbleContract
{

    public function attachment(): array
    {
        $filePath = MailDTO::getDailyCuttingUpdateAttachmentName();
        return [
    ...
    {
        return 'auto_mail.daily_cutting_update.mail_body';
    }

    public function subject(): string
    {
        return 'Daily Cutting Update';
    }

    public function receivers(): array
    {
        return MailDTO::getReceivers('daily_cutting_report');
    }
}
