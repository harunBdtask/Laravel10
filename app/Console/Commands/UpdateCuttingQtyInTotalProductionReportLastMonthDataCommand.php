...
class UpdateCuttingQtyInTotalProductionReportLastMonthDataCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'update:cutting-qty-in-total-production-report-last-month-data';
     ...
     * @var string
     */
    protected $description = 'Update Cutting Qty In TotalProductionReport Last Month Data Command';
