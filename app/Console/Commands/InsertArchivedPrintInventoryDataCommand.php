...
class InsertArchivedPrintInventoryDataCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'insert:archived-print-inventory-data';
     ...
     * @var string
     */
    protected $description = 'Insert Archived Print Inventory Data Command';
        ...
        try {
            ...
            DB::table('sewingoutputs')
                ...
                ->chunk($chunk_data_count, function ($sewingoutputs) use (&$counter) {
                    DB::beginTransaction();
                    $print_inventories = DB::table('print_inventories')->whereIn('bundle_card_id', $sewingoutputs->pluck('bundle_card_id')->toArray())->get();
