...
class InsertArchivedBundleCardPreviousYearDataCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'insert:archived-bundle-card-previous-year-data';
     ...
     * @var string
     */
    protected $description = 'Insert Archived BundleCard Previous Year Data Command';
    ...
    public function handle()
    {
        try {
            ...
            DB::table('bundle_cards')
                ...
                ->chunk($chunk_data_count, function ($bundle_cards) use (&$counter) {
                    DB::beginTransaction();
