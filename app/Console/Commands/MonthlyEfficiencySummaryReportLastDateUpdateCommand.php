...
class MonthlyEfficiencySummaryReportLastDateUpdateCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'update-last-date:monthly-efficiency-summary-report';
     ...
     * @var string
     */
    protected $description = 'Update Last Date Monthly Efficiency Summary Report';
    ...
    public function handle()
    {
        try {
            ...
            if ($sewingOutputs && count($sewingOutputs)) {
                ...
                $this->updateData($date, $sewingOutputs);
            }
